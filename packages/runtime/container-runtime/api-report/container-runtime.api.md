...
export class ChannelCollection implements IFluidDataStoreChannel, IDisposable {
    ...
    // (undocumented)
    protected createContext<T extends LocalFluidDataStoreContext>(id: string, pkg: Readonly<string[]>, contextCtor: new (props: ILocalDetachedFluidDataStoreContextProps) => T, createProps?: any): T;
    // (undocumented)
    createDataStoreContext(pkg: Readonly<string[]>, props?: any): IFluidDataStoreContextInternal;
